...
export declare function _getKeyAttestationSend(context: Client, keyName: string, keyVersion: string | undefined, options?: GetKeyAttestationOptionalParams): StreamableMethod;
...
export declare function getKeyAttestation(context: Client, keyName: string, keyVersion: string | undefined, options?: GetKeyAttestationOptionalParams): Promise<KeyBundle>;
...
export declare function _releaseSend(context: Client, keyName: string, keyVersion: string | undefined, parameters: KeyReleaseParameters, options?: ReleaseOptionalParams): StreamableMethod;
...
export declare function release(context: Client, keyName: string, keyVersion: string | undefined, parameters: KeyReleaseParameters, options?: ReleaseOptionalParams): Promise<KeyReleaseResult>;
