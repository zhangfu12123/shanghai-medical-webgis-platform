...
var keyVaultClient_exports = {};
__export(keyVaultClient_exports, {
  KeyVaultClient: () => KeyVaultClient
});
module.exports = __toCommonJS(keyVaultClient_exports);
...
class KeyVaultClient {
  ...
  constructor(endpointParam, credential, options = {}) {
    ...
    this._client = (0, import_api.createKeyVault)(endpointParam, credential, {
      ...options,
  ...
  getKeyAttestation(keyName, keyVersion, options = { requestOptions: {} }) {
    return (0, import_operations.getKeyAttestation)(this._client, keyName, keyVersion, options);
  }
  /** Get the requested number of bytes containing random values from a managed HSM. */
  getRandomBytes(parameters, options = { requestOptions: {} }) {
    return (0, import_operations.getRandomBytes)(this._client, parameters, options);
  }
  ...
  updateKeyRotationPolicy(keyName, keyRotationPolicy, options = { requestOptions: {} }) {
    return (0, import_operations.updateKeyRotationPolicy)(this._client, keyName, keyRotationPolicy, options);
  }
  ...
  unwrapKey(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.unwrapKey)(this._client, keyName, keyVersion, parameters, options);
  }
  ...
  wrapKey(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.wrapKey)(this._client, keyName, keyVersion, parameters, options);
  }
  ...
  verify(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.verify)(this._client, keyName, keyVersion, parameters, options);
  }
  /** The SIGN operation is applicable to asymmetric and symmetric keys stored in Azure Key Vault since this operation uses the private portion of the key. This operation requires the keys/sign permission. */
  sign(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.sign)(this._client, keyName, keyVersion, parameters, options);
  }
  ...
  decrypt(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.decrypt)(this._client, keyName, keyVersion, parameters, options);
  }
  ...
  encrypt(keyName, keyVersion, parameters, options = { requestOptions: {} }) {
    return (0, import_operations.encrypt)(this._client, keyName, keyVersion, parameters, options);
  }
  ...
  restoreKey(parameters, options = { requestOptions: {} }) {
    return (0, import_operations.restoreKey)(this._client, parameters, options);
  }
  ...
  backupKey(keyName, options = { requestOptions: {} }) {
    return (0, import_operations.backupKey)(this._client, keyName, options);
  }
