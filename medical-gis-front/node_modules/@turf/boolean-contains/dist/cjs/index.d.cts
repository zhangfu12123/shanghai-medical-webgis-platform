import { Feature, Geometry, BBox, Polygon, LineString, MultiPoint, MultiPolygon, Point } from 'geojson';
 ...
 * @returns {boolean} true/false
 */
declare function isPolyInPoly(feature1: Feature<Polygon> | Polygon, feature2: Feature<Polygon> | Polygon, feature2Bbox?: BBox): boolean;
...
export { booleanContains, compareCoords, doBBoxOverlap, getMidpoint, isLineInPoly, isLineOnLine, isMultiPointInMultiPoint, isMultiPointInPoly, isMultiPointOnLine, isMultiPolyInPoly, isPointInMultiPoint, isPolyInPoly, isPolygonInMultiPolygon };
