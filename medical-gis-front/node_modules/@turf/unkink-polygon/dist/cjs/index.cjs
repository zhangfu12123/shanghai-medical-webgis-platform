...
function simplepolygon(feature) {
  ...
  if (numSelfIsect == 0) {
    ...
    let output2 = _helpers.featureCollection.call(void 0, outputFeatureArray);
  ...
  let output = _helpers.featureCollection.call(void 0, outputFeatureArray);
      ...
      for (var i2 = 0; i2 < featuresWithoutParent.length; i2++) {
        ...
        for (var j2 = 0; j2 < output2.features.length; j2++) {
          ...
          if (_booleanpointinpolygon.booleanPointInPolygon.call(void 0, 
            ...
            if (_area.area.call(void 0, output2.features[j2]) < parentArea) {
              parent = j2;
            }
          }
        }
...
exports.default = index_default; exports.unkinkPolygon = unkinkPolygon;
