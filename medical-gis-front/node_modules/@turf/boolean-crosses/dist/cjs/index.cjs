...
function doLineStringsCross(lineString1, lineString2) {
  ...
  for (const intersectPoint of doLinesIntersect.features) {
    if (!_booleanequal.booleanEqual.call(void 0, intersectPoint, _helpers.point.call(void 0, lineString1.coordinates[0])) && !_booleanequal.booleanEqual.call(void 0, 
      intersectPoint,
      _helpers.point.call(void 0, lineString1.coordinates[lineString1.coordinates.length - 1])
    ) && !_booleanequal.booleanEqual.call(void 0, intersectPoint, _helpers.point.call(void 0, lineString2.coordinates[0])) && !_booleanequal.booleanEqual.call(void 0, 
      intersectPoint,
      _helpers.point.call(void 0, lineString2.coordinates[lineString2.coordinates.length - 1])
    )) {
      return true;
    }
  }
...
var index_default = booleanCrosses;



exports.booleanCrosses = booleanCrosses; exports.default = index_default;
