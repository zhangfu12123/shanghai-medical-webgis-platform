import { GeoJsonProperties, Feature, LineString, MultiLineString, Polygon, MultiPolygon, FeatureCollection } from 'geojson';
...
// @ts-ignore
export = polygonToLine;
export { coordsToLine, multiPolygonToLine, polygonToLine, singlePolygonToLine };
